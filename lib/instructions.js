...
function updateText(lvl) {
  ...
  switch(lvl) {
    case L.lesson1_2:
      ...
      instr = 'Ops sorry! I forgot to mention that Linux is case-sensitive, therefore <i>Echo</i> and <i>echo</i> are not the same.<br><br>A <i>command</i>(for example, <i>echo hello Kano</i>) is generally a program name (<i>echo</i>) follow by <i>arguments</i>(<i>hello Kano</i>).<br><br>Let\'s try it again, type <b> echo what ever comes into your mind</b> and see what the output is.';
      break;
    case L.lesson1_3:
